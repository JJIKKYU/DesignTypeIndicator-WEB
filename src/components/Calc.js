...
class Calc extends Component {
    ...
    checkType = () => {
        ...
        for (var i = 0; i < 20; ++i) {
            if (i < 5) typeEI += this.props.surveyResult[0].select[i];
            else if (i < 10) typeSN += this.props.surveyResult[0].select[i];
            else if (i < 15) typeTF += this.props.surveyResult[0].select[i];
            else if (i < 20) typeJP += this.props.surveyResult[0].select[i];
        }
            ...
            <>
                ...
                <div className="cardContainer">
                    <div className="cardStack">
                        <img
                            id="card1"
                            src="/images/calc/card_0.png"
                            alt="card1"
                        ></img>
                        <img
                            id="card2"
                            src="/images/calc/card_1.png"
                            alt="card2"
                        ></img>
                        <img
                            id="card3"
                            src="/images/calc/card_2.png"
                            alt="card3"
                        ></img>
                        <img
                            id="card4"
                            src="/images/calc/card_3.png"
                            alt="card4"
                        ></img>
                    </div>
                    <p className="calcText">결과 추출중...</p>
                </div>

                <div className="surveyMainCenter" id="surveyCalcCenter"></div>
