        ...
        return (
            ...
            <div className="main">
                ...
                <div className="genderTitleContainer">
                    ...
                    <img className="genderTextBGDesktop" src="./images/gender/genderTextBGDesktop.svg" alt=""/>
                    <div id="genderTitleContainer">
                        ...
                        <span className="orange">도형, 색상, 캐릭터</span>의 조합으로 결과를 도출되며 <br></br>
                        ...
                        <p className="intro introDesktop">
                        디자인 성향 검사 이하 DPTI
                        <span className="orange">(Design Pattern Type Indicator)</span>는
                        디자인 성향을 파악할 수 있는 테스트입니다. <br></br>
                        <span className="orange">도형, 색상, 캐릭터</span>의 조합으로 결과를 도출되며
